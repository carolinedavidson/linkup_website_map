...
illinois_polygon <- suppressMessages(st_read("IL_BNDY_State/IL_BNDY_State_Py.shp"))
```

```{r add map pop-up info to data}
#| echo: false
#| message: false
#| warning: false
...
my_map <- leaflet(options = leafletOptions(minZoom = 6)) %>%
  ...
  setMaxBounds(IL_bbox[1], IL_bbox[2], IL_bbox[3], IL_bbox[4])
...
# Add a search by address / zip code function and button to reset map to whole state view
